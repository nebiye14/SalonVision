                  ...
                  <div class="x_content">
                    ...
                    <form action="../netling/method.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="pr_fr_vision_inhalt" value="<?php echo $data['pr_fr_vision_inhalt'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
